...
/***/ "./resources/js/components/Ajax.js":
/*!*****************************************!*\
  !*** ./resources/js/components/Ajax.js ***!
  \*****************************************/
...
function Ajax() {
  var post = /*#__PURE__*/function () {
    var _ref = _asyncToGenerator( /*#__PURE__*/_babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_0___default.a.mark(function _callee(url, data) {
      return _babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_0___default.a.wrap(function _callee$(_context) {
        while (1) {
          switch (_context.prev = _context.next) {
            case 0:
              return _context.abrupt("return", axios.post(url, Object.assign({}, data)));
      ...
      return _babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_0___default.a.wrap(function _callee2$(_context2) {
        while (1) {
          switch (_context2.prev = _context2.next) {
            case 0:
              return _context2.abrupt("return", axios.put(url, Object.assign({}, data)));
      ...
      return _babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_0___default.a.wrap(function _callee3$(_context3) {
        while (1) {
          switch (_context3.prev = _context3.next) {
            case 0:
              return _context3.abrupt("return", axios.get(url));
...
var Modal = function () {
  ...
  Modal.prototype.show = function () {
    ...
    document.body.classList.add('overflow-hidden'); // Auto select first form input
  ...
  document.body.addEventListener('keyup', function (e) {
    ...
    if (key === 27) {
      ...
      if (openModal) {
        var btnConfirm = openModal.querySelector('.js-modal-confirm');
  ...
  btnSaveEntry.addEventListener('click', function (e) {
    ...
    listing.some(function (type) {
      ...
      if (type.getId() == entryModalForm.type.options[entryModalForm.type.selectedIndex].value) {
        // Find duplicate
        duplicateFound = type.getEntries().some(function (entry) {
          var newIdent2 = entryModalForm.ident_2.value || 'TBA';
  ...
  btnEditEntry.addEventListener('click', function (e) {
    ...
    listing.some(function (type) {
      ...
      if (type.getId() == editEntryModalForm.type.options[editEntryModalForm.type.selectedIndex].value) {
        // Find duplicate
        duplicateFound = type.getEntries().some(function (entry) {
          var newIdent2 = editEntryModalForm.ident_2.value || 'TBA';
